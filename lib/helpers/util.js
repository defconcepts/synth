exports(exports, sine, mirror, pluckWith, matchWith, swap,
        circle, is_mobile, dist, toCoord)

this.log = console.log.bind(console)

function exports() {
  var i = arguments.length
  while (i--) this[arguments[i].name] = arguments[i]
}
...
function pluckWith(name, useThis){
  return function (obj) {
    if (useThis === true) obj = this
